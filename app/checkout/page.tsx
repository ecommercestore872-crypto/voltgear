...
export default function CheckoutPage() {
  ...
  if (placedOrder) {
    return (
        <div className="min-h-screen bg-[#F4F9F8] py-8 lg:py-12 border-t border-border/40">
          <div className="container mx-auto max-w-6xl px-4 lg:px-8 space-y-6">
            
            {/* Top section: Status & Progress */}
            <div className="grid gap-6 lg:grid-cols-[1fr_560px] items-stretch">
               {/* Left: Thank You Banner */}
               <div className="rounded-2xl bg-white border border-border/60 p-8 flex flex-col sm:flex-row items-center sm:items-start gap-6 shadow-sm relative overflow-hidden">
                  {/* Subtle background decoration */}
                  <div className="absolute -left-16 -top-16 w-32 h-32 rounded-full border-[20px] border-primary/5 opacity-50" />
                  <div className="shrink-0 flex items-center justify-center relative">
                     <div className="w-24 h-24 rounded-full border-[6px] border-[#D1F1EB] bg-[#E8F8F5] flex items-center justify-center">
                        <Check className="w-12 h-12 text-[#13A387] stroke-[3]" />
                     </div>
                     {/* decorative floating pluses */}
                     <span className="absolute top-0 right-0 text-[#13A387] font-bold text-xs">+</span>
                     <span className="absolute bottom-4 left-0 text-[#13A387] font-bold text-xs">+</span>
                  </div>
                  <div className="flex-1 relative z-10 text-center sm:text-left mt-2 sm:mt-0">
                     <span className="inline-block px-3 py-1 rounded bg-[#E8F8F5] text-[#13A387] text-[11px] font-bold uppercase tracking-widest mb-3 border border-[#13A387]/20">
                        Thank You!
                     </span>
                     <h1 className="text-3xl sm:text-[34px] font-extrabold text-[#0D2F35] tracking-tight leading-tight mb-2">Order Confirmed!</h1>
                     <p className="text-sm font-medium text-muted-foreground leading-relaxed max-w-sm mx-auto sm:mx-0 pr-0 sm:pr-4">
               ...
               <div className="rounded-2xl bg-white border border-border/60 p-8 shadow-sm flex items-center justify-center">
                  <div className="w-full max-w-[420px] mx-auto grid grid-cols-4 relative text-center">
                     {/* Connecting Line */}
                     <div className="absolute left-[12.5%] right-[12.5%] top-4 h-[2px] border-t-2 border-dashed border-border -z-10" />
                     
                     <div className="flex flex-col items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-[#13A387] text-white flex items-center justify-center outline outline-[4px] outline-white shadow-sm shrink-0">
                           <Check className="w-4 h-4 stroke-[3]" />
                        </div>
                        <div className="mt-1">
                           <p className="text-xs font-bold text-[#0D2F35]">Confirmed</p>
                           <p className="text-[10px] font-semibold text-[#13A387] mt-1">{new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</p>
                        </div>
                     </div>

                     <div className="flex flex-col items-center gap-3 opacity-50">
                        <div className="w-8 h-8 rounded-full bg-white text-muted-foreground flex items-center justify-center outline outline-[3px] outline-white border border-border shadow-sm shrink-0">
                           <Package className="w-4 h-4" />
                        </div>
                        <div className="mt-1">
                           <p className="text-xs font-bold text-muted-foreground">Processing</p>
                           <p className="text-[10px] font-medium mt-1 leading-tight text-muted-foreground/80">We&rsquo;re preparing<br/>your order</p>
                        </div>
                     </div>
                     ...
                     <div className="flex flex-col items-center gap-3 opacity-50">
                        ...
                        <div className="mt-1">
                           <p className="text-xs font-bold text-muted-foreground">Shipped</p>
                           <p className="text-[10px] font-medium mt-1 leading-tight text-muted-foreground/80">On the way to<br/>you</p>
                        </div>
                     </div>
                     ...
                     <div className="flex flex-col items-center gap-3 opacity-50">
                        ...
                        <div className="mt-1">
                           <p className="text-xs font-bold text-muted-foreground">Delivered</p>
                           <p className="text-[10px] font-medium mt-1 leading-tight text-muted-foreground/80">Get ready to<br/>enjoy!</p>
                        </div>
                     </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_450px]">
               {/* Order Details */}
               <div className="rounded-2xl bg-white border border-border/60 shadow-sm overflow-hidden flex flex-col relative">
                  <div className="border-b border-border/60 p-5 flex items-center gap-3 bg-[#F4F9F8]/40">
                     <ClipboardList className="w-5 h-5 text-[#13A387]" strokeWidth={2.5}/>
                     <h3 className="font-bold text-[15px] text-[#0D2F35]">Order Details</h3>
                  </div>
                  <div className="p-6 grid gap-y-7 gap-x-6 sm:grid-cols-2">
                     <div className="flex gap-4 items-start">
                        <div className="w-8 h-8 rounded-full bg-[#E8F8F5] border border-[#13A387]/10 flex items-center justify-center text-[#13A387] shrink-0 font-bold tracking-tight">#</div>
                        <div className="mt-0.5">
                           <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">Order Number</p>
                           <p className="text-[14px] font-bold text-[#13A387] mt-1">{placedOrder}</p>
                        </div>
                     </div>
                     <div className="flex gap-4 items-start">
                        <div className="w-8 h-8 rounded-full bg-[#E8F8F5] border border-[#13A387]/10 flex items-center justify-center text-[#13A387] shrink-0"><Mail className="w-4 h-4"/></div>
                        <div className="mt-0.5">
                           <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">Confirmation Email</p>
                           <div className="flex flex-wrap items-center gap-2 mt-1">
                              <p className="text-[13px] font-bold text-[#0D2F35] truncate max-w-[150px] sm:max-w-none">{customer.email || 'customer@example.com'}</p>
                              <span className="text-[9px] font-bold bg-[#E8F8F5] text-[#13A387] px-1.5 py-0.5 rounded uppercase tracking-wider border border-[#13A387]/20">Sent</span>
                           </div>
                           <p className="text-[11px] text-muted-foreground mt-1">A confirmation has been sent to your email.</p>
                        </div>
                     </div>
                     <div className="flex gap-4 items-start">
                        <div className="w-8 h-8 rounded-full bg-[#E8F8F5] border border-[#13A387]/10 flex items-center justify-center text-[#13A387] shrink-0"><Calendar className="w-4 h-4"/></div>
                        <div className="mt-0.5">
                           <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">Order Date</p>
                           <p className="text-[13px] font-bold text-[#0D2F35] mt-1">{new Date().toLocaleString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })} &bull; {new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: 'numeric'})}</p>
                        </div>
                     </div>
                     <div className="flex gap-4 items-start">
                        <div className="w-8 h-8 rounded-full bg-[#E8F8F5] border border-[#13A387]/10 flex items-center justify-center text-[#13A387] shrink-0"><Truck className="w-4 h-4"/></div>
                        <div className="mt-0.5">
                           <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">Estimated Delivery</p>
                           <p className="text-[13px] font-bold text-[#0D2F35] mt-1">
                           ...
                           <p className="text-[11px] font-medium text-muted-foreground mt-1">(2–4 Working Days)</p>
                        </div>
                     </div>
                     <div className="flex gap-4 items-start">
                        <div className="w-8 h-8 rounded-full bg-[#E8F8F5] border border-[#13A387]/10 flex items-center justify-center text-[#13A387] shrink-0"><Banknote className="w-4 h-4"/></div>
                        <div className="mt-0.5">
                           <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">Payment Method</p>
                           <p className="text-[13px] font-bold text-[#0D2F35] mt-1">Cash on Delivery (COD)</p>
                        </div>
                     </div>
                     <div className="flex gap-4 items-start">
                        <div className="w-8 h-8 rounded-full bg-[#E8F8F5] border border-[#13A387]/10 flex items-center justify-center text-[#13A387] shrink-0"><MapPin className="w-4 h-4"/></div>
                        <div className="mt-0.5">
                           <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">Shipping Address</p>
                           <p className="text-[13px] font-bold text-[#0D2F35] mt-1">{customer.name || 'Ahmed Raza'}</p>
                     ...
                     <div className="flex gap-4 sm:col-span-2 pt-6 border-t border-border/40 items-start">
                        <div className="w-8 h-8 rounded-full bg-[#E8F8F5] border border-[#13A387]/10 flex items-center justify-center text-[#13A387] shrink-0"><ShoppingBag className="w-4 h-4"/></div>
                        <div className="mt-0.5">
                           <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">Total Amount</p>
                           <p className="text-[20px] font-black text-[#13A387] mt-1">{formatPrice(placedTotal ?? total)}</p>
                           <p className="text-[11px] font-medium text-muted-foreground mt-1">(Inclusive of all taxes)</p>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div className="flex flex-col gap-4">
                  <div className="rounded-2xl bg-white border border-border/60 shadow-sm overflow-hidden flex flex-col flex-1 relative">
                     <div className="border-b border-border/60 p-5 flex items-center justify-between bg-[#F4F9F8]/40">
                        <div className="flex items-center gap-3">
                           <ClipboardList className="w-5 h-5 text-[#13A387]" strokeWidth={2.5} />
                           <h3 className="font-bold text-[14px] text-[#0D2F35]">Items in Your Order ({items.length || 0})</h3>
                        </div>
                        <span className="text-[12px] font-bold text-[#13A387] hover:underline cursor-pointer">View Order Details</span>
                     </div>
                     <ul className="divide-y divide-border/60 p-5 flex-1 max-h-[360px] overflow-y-auto no-scrollbar">
                        {items.length === 0 ? (
                           <div className="text-center py-4 text-sm text-muted-foreground">Detailed loading items...</div>
                        ) : (
                           items.map((item) => (
                              <li key={cartLineKey(item)} className="py-5 flex gap-4 first:pt-2 last:pb-1">
                                 {item.image ? (
                                    <div className="h-14 w-14 shrink-0 rounded bg-white border border-border/50 relative overflow-hidden flex items-center justify-center p-1 shadow-sm">
                                      <Image src={item.image} alt={item.name} fill className="object-contain p-1" />
                                    </div>
                                 ) : (
                                    <div className="h-14 w-14 shrink-0 rounded bg-muted border border-border/50 shadow-sm" />
                                 )}
                                 <div className="flex flex-1 flex-col justify-center max-w-[calc(100%-80px)]">
                                    <div className="flex items-start justify-between gap-4 w-full">
                                       <div className="flex-1">
                                          <p className="text-[13px] font-bold text-[#0D2F35] line-clamp-2 leading-relaxed pr-2">{item.name}</p>
                                          {item.variantName ? (
                                             <p className="text-[11px] text-muted-foreground mt-1">{item.variantName}</p>
                                          ) : null}
                                          <p className="text-[12px] font-semibold text-muted-foreground mt-1.5">Qty: {item.quantity}</p>
                                       </div>
                                       <span className="text-[13px] font-extrabold text-[#0D2F35] tabular-nums shrink-0">{formatPrice(item.price)}</span>
                                    </div>
                                 </div>
                              </li>
                           ))
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 py-8">
               <Button size="lg" className="h-12 px-10 text-[14px] font-bold tracking-wide w-full sm:w-auto shadow-sm bg-[#0D2F35] hover:bg-[#0D2F35]/90 text-white border border-[#0D2F35]">
                  <Package className="w-4 h-4 mr-2" /> Track Your Order
               </Button>
               <Button asChild size="lg" variant="outline" className="h-12 px-10 text-[14px] font-bold tracking-wide w-full sm:w-auto bg-white hover:bg-muted text-[#0D2F35] border-border shadow-sm">
                  <Link href="/products">
                     <ShoppingBag className="w-4 h-4 mr-2 text-muted-foreground" /> Continue Shopping
                  </Link>
               </Button>
            </div>
            
            <div className="flex items-center justify-center gap-5 text-[13px] font-semibold text-[#13A387] pt-2">
               <button className="flex items-center gap-1.5 hover:underline decoration-[#13A387]/30 underline-offset-4"><ClipboardList className="w-4 h-4"/> Download Invoice</button>
               <span className="w-px h-3 bg-border" />
               <Link href="/contact" className="flex items-center gap-1.5 hover:underline text-muted-foreground decoration-muted-foreground/30 underline-offset-4"><Headphones className="w-4 h-4"/> Need help? <span className="text-[#13A387] font-bold ml-0.5 hover:underline decoration-[#13A387]/30 underline-offset-4">Contact Support</span></Link>
            </div>

            {/* Bottom Support Callouts */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 lg:mt-24 bg-white rounded-2xl border border-border/60 shadow-sm p-4 sm:p-6 w-full divide-y md:divide-y-0 md:divide-x divide-border">
               <div className="flex gap-5 p-2 md:p-4 pb-6 md:pb-4">
                  <div className="w-12 h-12 rounded-full bg-[#E8F8F5] text-[#13A387] flex items-center justify-center shrink-0 border border-[#13A387]/20 outline outline-[3px] outline-[#E8F8F5]/30">
                     <Headphones className="w-5 h-5"/>
                  </div>
                  <div className="pt-0.5">
                     <p className="text-[14px] font-bold text-[#0D2F35]">Need help with your order?</p>
                     <p className="text-[12px] text-muted-foreground mt-1 mb-3 leading-relaxed max-w-[220px]">We&rsquo;re here to help you with any questions or concerns.</p>
                     <Link href="/contact" className="text-[12.5px] font-bold text-[#13A387] flex items-center hover:underline group">Contact Support <ArrowRight className="w-3.5 h-3.5 ml-1.5 transition-transform group-hover:translate-x-0.5" /></Link>
                  </div>
               </div>
               <div className="flex gap-5 p-2 md:p-4 py-6 md:py-4">
                  <div className="w-12 h-12 rounded-full bg-[#E8F8F5] text-[#13A387] flex items-center justify-center shrink-0 border border-[#13A387]/20 outline outline-[3px] outline-[#E8F8F5]/30">
                     <ShieldCheck className="w-5 h-5"/>
                  </div>
                  <div className="pt-0.5">
                     <p className="text-[14px] font-bold text-[#0D2F35]">Easy Returns & Warranty</p>
                     <p className="text-[12px] text-muted-foreground mt-1 mb-3 leading-relaxed max-w-[220px]">7 days easy returns and 1 year warranty on all products.</p>
                     <Link href="/warranty" className="text-[12.5px] font-bold text-[#13A387] flex items-center hover:underline group">Learn More <ArrowRight className="w-3.5 h-3.5 ml-1.5 transition-transform group-hover:translate-x-0.5" /></Link>
                  </div>
               </div>
               <div className="flex gap-5 p-2 md:p-4 pt-6 md:pt-4">
                  <div className="w-12 h-12 rounded-full bg-[#E4F4EC] text-[#25D366] flex items-center justify-center shrink-0 border border-[#25D366]/20 outline outline-[3px] outline-[#E4F4EC]/30">
                  ...
                  <div className="pt-0.5">
                     <p className="text-[14px] font-bold text-[#0D2F35]">Chat with us on WhatsApp</p>
                     <p className="text-[12px] text-muted-foreground mt-1 mb-3 leading-relaxed max-w-[220px]">Get quick support on WhatsApp during business hours.</p>
                     <Link href="https://wa.me/92300000000" className="text-[12.5px] font-bold text-[#13A387] flex items-center hover:underline group">Chat Now <ArrowRight className="w-3.5 h-3.5 ml-1.5 transition-transform group-hover:translate-x-0.5" /></Link>
                  </div>
               </div>
            </div>
