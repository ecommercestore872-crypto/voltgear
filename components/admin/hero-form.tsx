    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="grid gap-4">
        ...
        <MediaField
          ...
          hint="Upload or paste image URLs for the homepage hero section. Format: JPG, WEBP, or PNG. Uploading 1 image displays a static hero; uploading 2 or more displays a slider carousel. Recommended size: 1920x1080px (16:9) to prevent distortion."
