  ...
  orders: [
    {
      ...
      answer:
        "We deliver across Pakistan in 1–2 business days for major cities and 2–4 business days for other areas.\n\nOnce your order is dispatched, you will receive a tracking link via SMS and email to monitor your delivery in real time.",
    },
    {
      id: "q_orders_2",
      question: "Do you offer Cash on Delivery?",
      answer:
        "Yes, we offer Cash on Delivery (COD) nationwide across Pakistan for all eligible orders. You can select this option at checkout.",
    },
    {
      id: "q_orders_3",
      question: "How can I track my order?",
      answer:
        "Use the tracking link sent to your email and SMS. Alternatively, log into your account and view your order history for real-time updates.",
    },
    {
      id: "q_orders_4",
      question: "What is your warranty policy?",
      answer:
        "All Buy n Try products come with a 1 Year Official Warranty against manufacturing defects.\n\nIf you face any issue, simply contact our support team with your order details and we'll arrange a replacement or repair.\n\nNote: Warranty does not cover physical damage, misuse, or normal wear and tear.",
    },
    {
      id: "q_orders_5",
      question: "Can I return a damaged product?",
      answer:
        "Absolutely. If you receive a damaged product, please inform us within 7 days of delivery with photographic evidence, and we will initiate a hassle-free return and replacement.",
    },
    {
      id: "q_orders_6",
      question: "Are your chargers compatible with iPhone and Android devices?",
      answer:
        "Yes, we stock PD chargers and cables that support both iOS (Apple) and Android devices. Please check individual product descriptions for specific compatibility limits (e.g. 20W vs 65W).",
    },
    {
      id: "q_orders_7",
      question: "Do you accept bulk or corporate orders?",
      answer:
        "Yes! We cater to corporate supplies and B2B bulk ordering. Please navigate to the 'Bulk Orders' section and submit an inquiry for a custom quotation.",
    },
    {
      id: "q_orders_8",
      question: "How quickly does support respond?",
      answer:
        "Our dedicated support team aims to reply within 15-30 minutes during standard business hours.",
    },
  ],
...
export function FaqInteractive() {
  ...
  const activeFaqs =
    FAQS_BY_CATEGORY[activeCategory] || FAQS_BY_CATEGORY["orders"];
          ...
          return (
            ...
            >
              <cat.icon
                className={cn(
                  "h-6 w-6 mb-3",
                  isActive ? "text-primary" : "text-[#7DBAB6]",
                )}
              />
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isOpen
                  ? "border-border shadow-sm border-l-[6px] border-l-primary"
