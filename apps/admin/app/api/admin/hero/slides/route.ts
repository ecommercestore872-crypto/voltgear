...
export const GET = withAdminApiObservability("GET /api/admin/hero/slides", GETHandler);
export const POST = withAdminApiObservability("POST /api/admin/hero/slides", POSTHandler);
