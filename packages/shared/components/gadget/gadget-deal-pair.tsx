...
export function GadgetDealPair({
  ...
  return (
    <section className="mt-10 rounded-2xl border border-[var(--g-line)] bg-[var(--g-white)] p-5">
      ...
      <h2 className="gadget-display mt-1 text-xl font-semibold">
        Buy together
      </h2>
      <p className="mt-1 text-sm text-[var(--g-taupe)]">
        Add this with your item. The percent comes off the cheaper product only
        — a cheap add-on cannot cut an expensive one.
      </p>
