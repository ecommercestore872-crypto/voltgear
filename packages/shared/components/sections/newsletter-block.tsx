      ...
      <div className="container mx-auto max-w-screen-xl px-4 md:px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-base text-slate-500 mb-8 max-w-lg mx-auto leading-relaxed">
            Get exclusive early access to tech deals, new premium arrivals, and
            a welcome gift delivered straight to your inbox.
          </p>
          ...
          {submitted ? (
            <div className="bg-emerald-50 text-emerald-800 border border-emerald-200 rounded-xl p-6 font-medium animate-in fade-in zoom-in duration-300">
              ...
              <p className="text-sm opacity-90 text-emerald-700">
                Check your inbox shortly for your exclusive welcome offer.
              </p>
            </div>
          ) : (
            <form
              onSubmit={handleSubmit}
              className="relative mx-auto flex w-full max-w-md min-w-0 flex-col gap-3 group sm:flex-row"
            >
              <div className="relative min-w-0 flex-1">
                <Mail
                  className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors"
                  strokeWidth={2}
                />
                <input
                  type="email"
              ...
              <Button
                type="submit"
                disabled={loading}
                className="h-14 w-full rounded-xl px-8 text-[15px] font-bold tracking-wide shadow-sm transition-all hover:shadow-md sm:w-auto"
              >
                {loading ? "..." : "Subscribe"}
              </Button>
            </form>
