...
**Function region:** Both **`apps/admin`** and **`apps/storefront`** use **`syd1`** so checkout and admin APIs sit near Supabase **Final-store** (Oceania). CDN still serves static assets globally.
